...
module.exports.run = async function({ api, event, Users, Threads }) {
  ...
  const type = (event.author == event.logMessageData.leftParticipantFbId) ? "  তোর সাহস কম নয় এখানে ༺𝐎𝐌𝐎ཞ༻•__//𝟗𝟎 থাকতে তুই লিভ নিস😡😠🤬 \n✢━━━━━━━━━━━━━━━✢\n ----❖----- 𝐎𝐌𝐎𝐑 𝐀𝐋𝐕𝐈 -----❖----" : "তোমার এই গ্রুপে থাকার কোনো যোগ্যাতা নেই আবাল😡।\nতাই তোমার লাথি মেরে গ্রুপ থেকে বের করে দেওয়া হলো🤪। WELLCOME REMOVE🤧 \n✢━━━━━━━━━━━━━━━✢\n ----❖----- 𝐎𝐌𝐎𝐑 𝐀𝐋𝐕𝐈 -----❖----";
